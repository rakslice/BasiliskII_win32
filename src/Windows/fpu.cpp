/*
 *  fpu.cpp - 68881/68040 fpu code for x86/Windows.
 *
...
static char * _fastcall etos( float80 e )
{
...
static void _fastcall signed_to_extended( uae_s32 x, float80 f )
{
...
static uae_s32 _fastcall extended_to_signed_32( float80 f )
{
	FPU_CONSISTENCY_CHECK_START();
	uae_s32 tmp;
	WORD sw_temp;
...
static uae_s16 _fastcall extended_to_signed_16( float80 f )
{
	FPU_CONSISTENCY_CHECK_START();
	uae_s16 tmp;
	WORD sw_temp;
...
static uae_s8 _fastcall extended_to_signed_8( float80 f )
{
	FPU_CONSISTENCY_CHECK_START();
	uae_s16 tmp;
	WORD sw_temp;
...
static void _fastcall double_to_extended( double x, float80 f )
{
	FPU_CONSISTENCY_CHECK_START();
...
static double _fastcall extended_to_double( float80 f )
{
	FPU_CONSISTENCY_CHECK_START();
	double result;
...
static void _fastcall to_single( uae_u32 src, float80 f )
{
	FPU_CONSISTENCY_CHECK_START();
	_asm {
		MOV			ESI, [f]
...
// TODO_BIGENDIAN
static void _fastcall to_exten_no_normalize( uae_u32 wrd1, uae_u32 wrd2, uae_u32 wrd3, float80 f )
{
	FPU_CONSISTENCY_CHECK_START();
	uae_u32 *p = (uae_u32 *)f;
...
static void _fastcall to_exten( uae_u32 wrd1, uae_u32 wrd2, uae_u32 wrd3, float80 f )
{
	FPU_CONSISTENCY_CHECK_START();
	uae_u32 *p = (uae_u32 *)f;
...
static void _fastcall to_double( uae_u32 wrd1, uae_u32 wrd2, float80 f )
{
	FPU_CONSISTENCY_CHECK_START();
	uae_u32 src[2];
...
static uae_u32 _fastcall from_single( float80 f )
{
	FPU_CONSISTENCY_CHECK_START();
	uae_u32 dest;
	WORD sw_temp;
...
// TODO_BIGENDIAN
static void _fastcall from_exten( float80 f, uae_u32 *wrd1, uae_u32 *wrd2, uae_u32 *wrd3 )
{
	FPU_CONSISTENCY_CHECK_START();
	uae_u32 *p = (uae_u32 *)f;
	*wrd3 = p[0];
...
static void _fastcall from_double( float80 f, uae_u32 *wrd1, uae_u32 *wrd2 )
{
	FPU_CONSISTENCY_CHECK_START();
	uae_u32 dest[2];
	WORD sw_temp;
...
static void _fastcall do_fmove( float80 dest, float80 src )
{
	FPU_CONSISTENCY_CHECK_START();
	_asm {
		MOV			ESI, [src]
...
/*
static void _fastcall do_fmove_no_status( float80 dest, float80 src )
{
	FPU_CONSISTENCY_CHECK_START();
	_asm {
		MOV			ESI, [src]
...
static void _fastcall do_fint( float80 dest, float80 src )
{
	FPU_CONSISTENCY_CHECK_START();
	_asm {
		MOV			ESI, [src]
...
static void _fastcall do_fintrz( float80 dest, float80 src )
{
	FPU_CONSISTENCY_CHECK_START();
	WORD cw_temp;
...
static void _fastcall do_fsqrt( float80 dest, float80 src )
{
	FPU_CONSISTENCY_CHECK_START();
	_asm {
		MOV			ESI, [src]
...
static void _fastcall do_ftst( float80 src )
{
	FPU_CONSISTENCY_CHECK_START();
	_asm {
		MOV			ESI, [src]
...
static void _fastcall do_fsinh( float80 dest, float80 src )
{
	FPU_CONSISTENCY_CHECK_START();
	double x, y;
...
static void _fastcall do_flognp1( float80 dest, float80 src )
{
	FPU_CONSISTENCY_CHECK_START();
	double x, y;
	x = extended_to_double( src );
...
static void _fastcall do_fetoxm1( float80 dest, float80 src )
{
	FPU_CONSISTENCY_CHECK_START();
	double x, y;
	x = extended_to_double( src );
...
static void _fastcall do_ftanh( float80 dest, float80 src )
{
	FPU_CONSISTENCY_CHECK_START();
	double x, y;
	x = extended_to_double( src );
...
static void _fastcall do_fatan( float80 dest, float80 src )
{
	FPU_CONSISTENCY_CHECK_START();
	double x, y;
	x = extended_to_double( src );
...
static void _fastcall do_fasin( float80 dest, float80 src )
{
	FPU_CONSISTENCY_CHECK_START();
	double x, y;
	x = extended_to_double( src );
...
static void _fastcall do_fatanh( float80 dest, float80 src )
{
	FPU_CONSISTENCY_CHECK_START();
	double x, y;
	x = extended_to_double( src );
...
static void _fastcall do_fetox( float80 dest, float80 src )
{
	FPU_CONSISTENCY_CHECK_START();
	double x, y;
	x = extended_to_double( src );
...
static void _fastcall do_ftwotox( float80 dest, float80 src )
{
	FPU_CONSISTENCY_CHECK_START();
	double x, y;
	x = extended_to_double( src );
...
static void _fastcall do_ftentox( float80 dest, float80 src )
{
	FPU_CONSISTENCY_CHECK_START();
	double x, y;
	x = extended_to_double( src );
...
static void _fastcall do_flogn( float80 dest, float80 src )
{
	FPU_CONSISTENCY_CHECK_START();
	double x, y;
	x = extended_to_double( src );
...
static void _fastcall do_flog10( float80 dest, float80 src )
{
	FPU_CONSISTENCY_CHECK_START();
	double x, y;
	x = extended_to_double( src );
...
static void _fastcall do_flog2( float80 dest, float80 src )
{
	FPU_CONSISTENCY_CHECK_START();
	double x, y;
	x = extended_to_double( src );
...
static void _fastcall do_facos( float80 dest, float80 src )
{
	FPU_CONSISTENCY_CHECK_START();
	double x, y;
	x = extended_to_double( src );
...
static void _fastcall do_fcosh( float80 dest, float80 src )
{
	FPU_CONSISTENCY_CHECK_START();
	double x, y;
	x = extended_to_double( src );
...
static void _fastcall do_fsin( float80 dest, float80 src )
{
	FPU_CONSISTENCY_CHECK_START();
	_asm {
		MOV			ESI, [src]
...
static void _fastcall do_ftan( float80 dest, float80 src )
{
	FPU_CONSISTENCY_CHECK_START();
	_asm {
		MOV			ESI, [src]
...
static void _fastcall do_fabs( float80 dest, float80 src )
{
	FPU_CONSISTENCY_CHECK_START();
	_asm {
		MOV			ESI, [src]
...
static void _fastcall do_fneg( float80 dest, float80 src )
{
	FPU_CONSISTENCY_CHECK_START();
	_asm {
		MOV			ESI, [src]
...
static void _fastcall do_fcos( float80 dest, float80 src )
{
	FPU_CONSISTENCY_CHECK_START();
	_asm {
		MOV			ESI, [src]
...
static void _fastcall do_fgetexp( float80 dest, float80 src )
{
	FPU_CONSISTENCY_CHECK_START();
	_asm {
		MOV			ESI, [src]
...
static void _fastcall do_fgetman( float80 dest, float80 src )
{
	FPU_CONSISTENCY_CHECK_START();
	_asm {
		MOV			ESI, [src]
...
static void _fastcall do_fdiv( float80 dest, float80 src )
{
	FPU_CONSISTENCY_CHECK_START();
	_asm {
		MOV			ESI, [src]
...
static void _fastcall do_fmod( float80 dest, float80 src )
{
	FPU_CONSISTENCY_CHECK_START();
...
static void _fastcall do_frem( float80 dest, float80 src )
{
	FPU_CONSISTENCY_CHECK_START();
...
#if !USE_3_BIT_QUOTIENT
static void _fastcall do_fmod_dont_set_cw( float80 dest, float80 src )
{
	FPU_CONSISTENCY_CHECK_START();
...
static void _fastcall do_frem_dont_set_cw( float80 dest, float80 src )
{
	FPU_CONSISTENCY_CHECK_START();
...
static void _fastcall do_fadd( float80 dest, float80 src )
{
	FPU_CONSISTENCY_CHECK_START();
	_asm {
		MOV			ESI, [src]
...
static void _fastcall do_fmul( float80 dest, float80 src )
{
	FPU_CONSISTENCY_CHECK_START();
	_asm {
		MOV			ESI, [src]
...
static void _fastcall do_fsgldiv( float80 dest, float80 src )
{
	FPU_CONSISTENCY_CHECK_START();
	WORD cw_temp;
	_asm {
...
static void _fastcall do_fscale( float80 dest, float80 src )
{
	FPU_CONSISTENCY_CHECK_START();
	_asm {
		MOV			ESI, [src]
...
static void _fastcall do_fsglmul( float80 dest, float80 src )
{
	FPU_CONSISTENCY_CHECK_START();
	WORD cw_temp;
...
static void _fastcall do_fsub( float80 dest, float80 src )
{
	FPU_CONSISTENCY_CHECK_START();
	_asm {
		MOV			ESI, [src]
...
static void _fastcall do_fsincos( float80 dest_sin, float80 dest_cos, float80 src )
{
	FPU_CONSISTENCY_CHECK_START();
	_asm {
		MOV			ESI, [src]
...
static void _fastcall do_fcmp( float80 dest, float80 src )
{
	FPU_CONSISTENCY_CHECK_START();
	_asm {
		MOV			ESI, [src]
...
static double _fastcall to_pack(uae_u32 wrd1, uae_u32 wrd2, uae_u32 wrd3)
{
	FPU_CONSISTENCY_CHECK_START();
...
// More or less original. Should be reviewed.
static void _fastcall from_pack(double src, uae_u32 * wrd1, uae_u32 * wrd2, uae_u32 * wrd3)
{
	FPU_CONSISTENCY_CHECK_START();
...
static int _fastcall get_fp_value (uae_u32 opcode, uae_u16 extra, float80 src)
{
  ...
  switch ((uae_u8)mode) {
    ...
    case 5:
			...
			break;
    case 6:
			ad = get_disp_ea_020 (m68k_areg (regs, reg), next_iword_020());
			break;
    case 7:
			switch ((uae_u8)reg) {
				case 0:
				...
				case 3: {
					...
					uae_u16 tmp = (uae_u16)next_iword_020();
...
static int __inline__ put_fp_value (float80 value, uae_u32 opcode, uae_u16 extra)
{
...
static int _fastcall get_fp_ad(uae_u32 opcode, uae_u32 * ad)
{
  int mode = (opcode >> 3) & 7;
  int reg = opcode & 7;
  switch ( (uae_u8)mode ) {
...
static int _fastcall fpp_cond(uae_u32 opcode, int condition)
{
...
static void _fastcall do_fldpi( float80 dest )
{
	FPU_CONSISTENCY_CHECK_START();
	_asm {
		FLDPI
...
static void _fastcall do_fldlg2( float80 dest )
{
	FPU_CONSISTENCY_CHECK_START();
	_asm {
		FLDLG2
...
static void _fastcall do_fldl2e( float80 dest )
{
	FPU_CONSISTENCY_CHECK_START();
	_asm {
		FLDL2E
...
static void _fastcall do_fldz( float80 dest )
{
	FPU_CONSISTENCY_CHECK_START();
	_asm {
		FLDZ
...
static void _fastcall do_fldln2( float80 dest )
{
	FPU_CONSISTENCY_CHECK_START();
	_asm {
		FLDLN2
...
static void _fastcall do_fld1( float80 dest )
{
	FPU_CONSISTENCY_CHECK_START();
	_asm {
		FLD1
